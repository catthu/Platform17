"""
Django settings for Platform17 project on Heroku. For more info, see:
...
WSGI_APPLICATION = 'Platform17.wsgi.application'
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [os.environ.get('REDISTOGO_URL', 'redis://127.0.0.1:6379')],
        },
